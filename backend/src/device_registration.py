...
class DeviceRegistration:
    ...
    async def show_welcome_screen(self, display_manager):
        ...
        try:
            ...
            # Load fonts (readable sizes for 800x480 display)
            try:
            ...
            draw.text((center_x - title_width // 2, 30), title_text, font=font_title, fill=(0, 0, 0))
            ...
            draw.text((center_x - instruction1_width // 2, 110), instruction1, font=font_medium, fill=(0, 0, 0))
            ...
            draw.text((center_x - instruction2_width // 2, 155), instruction2, font=font_medium, fill=(0, 100, 200))
            ...
            draw.rectangle([box_left, box_top, box_right, box_bottom], outline=(255, 100, 0), width=4)
            ...
            draw.text((center_x - device_width // 2, 410), device_text, font=font_small, fill=(128, 128, 128))
