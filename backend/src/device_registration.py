...
class DeviceRegistration:
    ...
    async def show_welcome_screen(self, display_manager):
        ...
        try:
            ...
            try:
                font_title = ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf', 84)
                font_large = ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf', 70)
                font_medium = ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf', 44)
            ...
            draw.text((center_x - instruction1_width // 2, 125), instruction1, font=font_medium, fill=(0, 0, 0))
            ...
            draw.text((center_x - instruction2_width // 2, 180), instruction2, font=font_medium, fill=(0, 100, 200))
            ...
            draw.text((center_x - device_width // 2, 430), device_text, font=font_small, fill=(128, 128, 128))
